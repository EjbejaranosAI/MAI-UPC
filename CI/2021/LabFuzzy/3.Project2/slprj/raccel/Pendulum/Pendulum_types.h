...
Block [ 33 ] ; uint8_T OutOfRangeInputValue ; uint8_T NoRuleFired ; uint8_T
EmptyOutputFuzzySet ; uint8_T sl_padding0 [ 3 ] ; }
struct_slmtA0QxwbT8yc5iP4GAzD ;
#endif
...
#endif
#ifndef DEFINED_TYPEDEF_FOR_struct_qZn2gh8CaG9v9WdC8eRmw_
#define DEFINED_TYPEDEF_FOR_struct_qZn2gh8CaG9v9WdC8eRmw_
...
struct_FOoMlVQ4d9OgoZkrIa8vkE outputMF ; real_T antecedent [ 18 ] ; real_T
...
uint8_T sl_padding1 [ 4 ] ; } struct_qZn2gh8CaG9v9WdC8eRmw ;
#endif
typedef struct P_ P ;
#endif
